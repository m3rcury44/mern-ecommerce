...
import classes from "./CategoryGridItem.module.scss";
...
const CategoryGridItem: FC<IItem> = ({item}) => {
    ...
    return (
        <div className={classes.item}>
            ...
            <div className={classes.itemFooter}>
                ...
                <div style={{display: 'flex', alignItems: 'center', gap: '10px'}} className={classes.itemFavorite}>
                    <MyButton style={{padding: '5px'}} onClick={addToFavorites}>
                        {productId
